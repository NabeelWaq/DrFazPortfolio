...
const Contact = () => {
  ...
  return (
    <div className='flex flex-col w-full min-h-[130vh] md:h-[130vh] bg-[url("/contact.webp")] bg-cover bg-right md:bg-center mt-24 px-4 md:px-8 py-8 justify-center items-center relative'>
