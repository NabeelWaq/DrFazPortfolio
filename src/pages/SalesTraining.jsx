...
const Coaching = () => {
  ...
  return (
    <div className='w-full min-h-screen relativ mt-[108px]'>
      {/* Section 1 */}
      <div className="w-full min-h-screen md:min-h-[70vh] bg-[url('/s4.webp')] bg-top bg-cover relative flex items-center justify-center">
  ...
  wrapperStyle
  wrapperClass
/>}>  <Video thumb={'/thumb5.webp'} videoRef={videoRef1} videoSrc={"/videos/4.mp4"} /></Suspense>
        </div>
      </div>
      </div>
       {/* section 5 */}
  ...
  wrapperStyle
  wrapperClass
/>}>  <Video thumb={'/thumb6.webp'} videoRef={videoRef2} videoSrc={"/videos/5.mp4"} /></Suspense>
        </div>
        <div className="w-full md:w-[50%] min-h-full flex flex-col gap-4 md:mr-14 items-center md:items-start justify-center">
